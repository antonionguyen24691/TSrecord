...
const runMigrations = (db: Database.Database) => {
  ...
  const defaults: Array<[string, string, string]> = [
    ...
    ['zalo_oa_follow_url', '', 'URL Zalo OA/follow mặc định'],
    ['pricing_contact_enabled', 'true', 'Hiển thị dock liên hệ trên website công khai'],
    ['pricing_contact_label', 'Tư vấn mua gói', 'Nhãn nút bot/tư vấn trên dock liên hệ'],
    ['pricing_sales_phone', '', 'Số điện thoại sales cho trang giá'],
    ['pricing_zalo_url', '', 'URL chat Zalo cho trang giá'],
    ['pricing_bot_url', '', 'URL bot/tư vấn mua gói cho trang giá'],
