const ENV_MAP: Record<string, string> = {
  ...
  hkd_phone: 'HKD_PHONE',
  zalo_oa_follow_url: 'ZALO_OA_FOLLOW_URL',
  pricing_contact_enabled: 'PRICING_CONTACT_ENABLED',
  pricing_contact_label: 'PRICING_CONTACT_LABEL',
  pricing_sales_phone: 'PRICING_SALES_PHONE',
  pricing_zalo_url: 'PRICING_ZALO_URL',
  pricing_bot_url: 'PRICING_BOT_URL',
