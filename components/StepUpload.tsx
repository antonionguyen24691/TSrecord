...
export const StepUpload: React.FC<StepUploadProps> = ({
  ...
  const contextOptions = [
    { id: SessionContext.TRANSCRIPTION, title: 'Transcript', icon: FileText },
    { id: SessionContext.MEETING, title: 'Biên bản họp', icon: BriefcaseBusiness },
    { id: SessionContext.INTERVIEW, title: 'Phỏng vấn', icon: Users },
  ];
      ...
      <div className="w-full max-w-5xl rounded-[26px] border border-white/60 bg-white/90 p-4 md:rounded-[36px] md:p-8 shadow-[0_28px_90px_rgba(15,23,42,0.10)]">
        <div className="flex items-end justify-between gap-3">
          ...
          <button
            ...
            className="inline-flex h-11 items-center gap-2 rounded-xl bg-[#0d7c66] px-4 text-sm font-bold text-white"
          >
        ...
        {!file ? (
          <div
            ...
            onDrop={handleDrop}
          >
            <button type="button" onClick={() => fileInputRef.current?.click()} className="w-full text-center">
              <input
                ref={fileInputRef}
                type="file"
                className="hidden"
